...
public class InMemoryArtistService implements ArtistService {
    ...
    private void initData()  {
        ...
        addArtist("Leonardo Vinci", "Renaissance master and polymath.", new Date(1452), "leo@vincistudio.it", "Florence",
                "Painting", "Sculpture");
        addArtist("Claude Monet", "Founder of French Impressionist painting.", new Date(1840), "claude@monet.fr", "Giverny",
                "Painting");
        addArtist("Ansel Adams", "American landscape photographer and environmentalist.", new Date(1902), "ansel@adams.co",
                "San Francisco", "Photography");
        addArtist("Frida Kahlo", "Mexican painter known for her many portraits and self-portraits.", new Date(1907),
                "frida@kahlo.mx", "Mexico City", "Painting");
        addArtist("Auguste Rodin", "French sculptor, generally considered the founder of modern sculpture.", new Date(1906),
    ...
    private void addArtist(String name, String bio, Date year, String email, String city, String... disciplineNames) {
